...
#define METAGEN_TYPE_vec2i (METAGEN_TYPE_CUSTOM_BEGIN + 2)
#define METAGEN_TYPE_vec3f (METAGEN_TYPE_CUSTOM_BEGIN + 3)
#define METAGEN_TYPE_range3f (METAGEN_TYPE_CUSTOM_BEGIN + 4)
#define METAGEN_PRINT_MEMB_CUSTOM \
         ...
         case METAGEN_TYPE_vec2i: Str8ListPushLast(arena, list, StructToStr8(arena, (Any){.data = ((u8*)(member) + (size*i)), .info = gvec2iStructInfo})); break;\
